                ...
                try (FileInputStream inputFile = new FileInputStream(file)) {
                    ...
                    for (int temp = 0; temp < nList.getLength(); temp++) {
                        ...
                        if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                            ...
                            Scanner input = new Scanner (eElement.getElementsByTagName("coordinates").item(0).getTextContent());
        ...
        try {
            ...
            if(myRs1 != null) {
                while(myRs1.next()) {
                    ...
                    ZonePolygon tempZone = convertZoneToPolygon(Integer.parseInt(myRs1.getString("UNQ_ZONE_ID")));
                    list.add(tempZone);
